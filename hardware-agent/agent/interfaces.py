...
class InvoicePayload(BaseModel):
    ...
    # 端點不得印出本機自算的半套證明聯）。
    barcode_content: str = Field(min_length=19, max_length=40)
    qrcode_left_content: str = Field(min_length=1, max_length=500)
    qrcode_right_content: str = Field(min_length=1, max_length=500)
