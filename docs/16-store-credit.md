...
- **回看視窗**：昨日／近 7 天／近 30 天／近 90 天／去年同期（同月日 ±15 天，`yoy_halfwidth_days` 可調）。各視窗分別算 `take_rate`、`avg_premium_rate`、`beta_retention`、`alpha_incremental`、`gross_margin_m`、負債比；UI 全部展示。
